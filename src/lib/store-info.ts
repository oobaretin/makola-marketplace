export const STORE_INFO = {
  ...
  /** Google Maps Directions — from current location to store (Houston traffic hack). */
  mapsDirectionsUrl:
    "https://www.google.com/maps/dir/?api=1&destination=9051+W+Bellfort+Ave+Houston+TX+77031",
